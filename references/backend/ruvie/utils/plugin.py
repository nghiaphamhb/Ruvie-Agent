...
from ruvie.models.functions import FunctionModel, Functions
...
def replace_imports(content):
    ...
    """
    replacements = {
        'from utils': 'from ruvie.utils',
        'from apps': 'from ruvie.apps',
        'from main': 'from ruvie.main',
        'from config': 'from ruvie.config',
    }
