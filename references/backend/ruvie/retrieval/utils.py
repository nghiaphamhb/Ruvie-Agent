...
from ruvie.retrieval.vector.main import GetResult, SearchResult
from ruvie.retrieval.web.utils import get_web_loader
from ruvie.utils.access_control.files import has_access_to_file
from ruvie.utils.headers import include_user_info_headers
from ruvie.utils.misc import get_message_list
...
def build_loader_from_config(request, config: dict):
    ...
    from ruvie.retrieval.loaders.main import Loader
...
def _get_content_from_url_sync(request, url: str, loader_config):
    from ruvie.retrieval.web.utils import validate_url, _SSRFSafeAdapter
