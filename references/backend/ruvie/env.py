...
# OPEN_WEBUI_DIR should be the directory where env.py resides (ruvie/)
...
try:
    ...
    changelog_content = (pkgutil.get_data('ruvie', 'CHANGELOG.md') or b'').decode()
...
WEBUI_NAME = os.getenv('WEBUI_NAME', 'Ruvie')
if WEBUI_NAME != 'Ruvie':
    WEBUI_NAME += ' (Ruvie)'
