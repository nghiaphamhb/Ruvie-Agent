...
# local imports
from ruvie.internal.db import Base, JSONField, get_async_db_context
from ruvie.models.automations import AutomationRun
from ruvie.models.chat_messages import ChatMessage, ChatMessages
from ruvie.models.folders import Folders
from ruvie.models.tags import Tag, TagModel, Tags
from ruvie.utils.misc import sanitize_data_for_db, sanitize_text_for_db
...
class ChatTable:
    ...
    async def insert_shared_chat_by_chat_id(self, chat_id: str, db: AsyncSession | None = None) -> ChatModel | None:
        ...
        from ruvie.models.shared_chats import SharedChats
    ...
    async def get_chats_by_model_id(
        ...
        from ruvie.models.users import User
    ...
    async def delete_shared_chats_by_user_id(self, user_id: str, db: AsyncSession | None = None) -> bool:
        ...
        from ruvie.models.shared_chats import SharedChat as SharedChatTable
        from ruvie.models.shared_chats import SharedChats
