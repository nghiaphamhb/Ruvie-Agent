...
from ruvie.internal.db import Base, get_async_db_context
from ruvie.models.access_grants import AccessGrantModel, AccessGrants
from ruvie.models.groups import Groups
from ruvie.models.users import User, UserModel, UserResponse
...
class CalendarEventTable:
    ...
    async def get_upcoming_events(
        ...
        *grace_ns* widens the SQL lower bound so that events whose start_at
        ...
        time.
        """
        from ruvie.models.users import User as UserRow
