...
from ruvie.env import DATABASE_USER_ACTIVE_STATUS_UPDATE_INTERVAL
from ruvie.internal.db import Base, JSONField, get_async_db_context
from ruvie.utils.misc import throttle
...
class UsersTable:
    ...
    async def get_users(
        ...
        async with get_async_db_context(db) as session:
            ...
            from ruvie.models.channels import ChannelMember
            from ruvie.models.groups import GroupMember
