...
from ruvie.constants import TASKS
...
from ruvie.models.folders import Folders
from ruvie.models.functions import Functions
from ruvie.models.models import Models
from ruvie.models.oauth_sessions import OAuthSessions
from ruvie.models.users import UserModel, Users
from ruvie.retrieval.utils import get_sources_from_items
...
from ruvie.routers.pipelines import (
...
from ruvie.routers.tasks import (
    generate_chat_tags,
    generate_follow_ups,
...
from ruvie.utils.access_control import has_connection_access, has_permission
from ruvie.utils.access_control.files import get_accessible_folder_files
from ruvie.utils.chat import generate_chat_completion
from ruvie.utils.code_interpreter import execute_code_jupyter
from ruvie.utils.context_compaction import compact_messages_for_request
from ruvie.utils.files import (
    convert_markdown_base64_images,
    get_file_url_from_base64,
    get_image_base64_from_url,
    get_image_url_from_base64,
)
from ruvie.utils.filter import (
    get_sorted_filter_ids,
    process_filter_functions,
)

from ruvie.utils.mcp.client import MCPClient
from ruvie.utils.memory import add_memory_context, review_memory_after_turn
...
from ruvie.utils.payload import apply_system_prompt_to_body, resolve_system_prompt
from ruvie.utils.plugin import load_function_module_by_id
from ruvie.utils.response import merge_usage, normalize_usage
from ruvie.utils.sanitize import sanitize_code
from ruvie.utils.task import (
    get_task_model_id,
    rag_template,
    tools_function_calling_generation_template,
)
from ruvie.utils.tools import (
...
from ruvie.utils.webhook import post_webhook
...
async def process_chat_payload(request, form_data, user, metadata, model):
    ...
    if skill_ids:
        from ruvie.models.skills import Skills as SkillsModel
