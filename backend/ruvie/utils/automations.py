...
from ruvie.internal.db import get_async_db
from ruvie.models.automations import AutomationModel, AutomationRuns, Automations
from ruvie.models.chats import ChatForm, Chats
from ruvie.models.config import Config
from ruvie.models.users import Users
from ruvie.utils.auth import create_token
from ruvie.utils.misc import parse_duration
from ruvie.utils.task import prompt_template
...
async def _set_terminal_cwd(app, server_id: str, user, cwd: str, chat_id: str) -> None:
    ...
    """
    import aiohttp
    from ruvie.env import AIOHTTP_CLIENT_SESSION_SSL
...
async def execute_automation(app, automation: AutomationModel) -> None:
    ...
    try:
        ...
        from ruvie.socket.main import sio
...
async def _check_calendar_alerts(app) -> None:
    ...
    """
    from ruvie.models.calendar import CalendarEvents, CalendarEventUpdateForm
    from ruvie.socket.main import sio
