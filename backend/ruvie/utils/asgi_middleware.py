...
from ruvie.env import CUSTOM_API_KEY_HEADER
from ruvie.internal.db import ScopedSession
from ruvie.models.config import Config
from ruvie.utils.auth import get_http_authorization_cred
        ...
        if 'shared' in query_params and query_params['shared']:
            ...
            if text:
                ...
                if url_match:
                    ...
                    # YouTube URL.
                    from ruvie.retrieval.loaders.youtube import _parse_video_id
