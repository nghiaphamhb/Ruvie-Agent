...
from ruvie.tools.builtin import (
    add_memory,
    calculate_timestamp,
    create_automation,
...
from ruvie.utils.access_control import has_access, has_connection_access, has_permission
from ruvie.utils.headers import get_custom_headers, include_user_info_headers
from ruvie.utils.misc import is_string_allowed
from ruvie.utils.plugin import get_tool_contents_cache, get_tools_cache, load_tool_module_by_id
...
async def get_builtin_tools(
    ...
    if is_builtin_tool_enabled('knowledge'):
        from ruvie.env import ENABLE_KB_EXEC
