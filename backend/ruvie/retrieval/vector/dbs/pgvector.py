...
from ruvie.retrieval.vector.main import (
    GetResult,
    SearchResult,
    VectorDBBase,
    VectorItem,
)
from ruvie.retrieval.vector.utils import merge_hybrid_search_results, process_metadata
from ruvie.utils.misc import sanitize_text_for_db
...
class PgvectorClient(VectorDBBase):
    def __init__(self) -> None:
        ...
        if not PGVECTOR_DB_URL:
            from ruvie.internal.db import ScopedSession
    ...
    def _ensure_vector_index(self, index_method: str, index_options: str) -> None:
        ...
        if existing_method and existing_method != index_method:
            raise RuntimeError(
                ...
                'and recreate it with the new method before restarting Ruvie.'
            )
