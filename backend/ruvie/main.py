...
from ruvie.constants import ERROR_MESSAGES, TASKS
...
from ruvie.internal.db import engine, get_async_session
from ruvie.models.access_grants import AccessGrants
from ruvie.models.channels import Channels
from ruvie.models.chats import ChatForm, Chats
from ruvie.models.config import Config
from ruvie.models.functions import Functions
from ruvie.models.messages import Messages
from ruvie.models.models import Models
from ruvie.models.users import Users
from ruvie.routers import (
    analytics,
    audio,
    auths,
    automations,
...
from ruvie.routers.retrieval import (
    get_ef,
    get_embedding_function,
    get_reranking_function,
    get_rf,
)
from ruvie.socket.main import (
    MODELS,
    get_event_emitter,
    get_models_in_use,
...
from ruvie.utils import logger
from ruvie.utils.access_control import has_permission
from ruvie.utils.actions import chat_action as chat_action_handler
from ruvie.utils.asgi_middleware import (
    AuthTokenMiddleware,
    CommitSessionMiddleware,
    RedirectMiddleware,
    WebsocketUpgradeGuardMiddleware,
)
from ruvie.utils.audit import AuditLevel, AuditLoggingMiddleware
from ruvie.utils.auth import (
    create_admin_user,
    decode_token,
    get_admin_user,
...
from ruvie.utils.chat import (
    chat_completed as chat_completed_handler,
)
from ruvie.utils.chat import (
    generate_chat_completion as chat_completion_handler,
)
from ruvie.utils.embeddings import generate_embeddings
from ruvie.utils.logger import start_logger
from ruvie.utils.middleware import (
    background_tasks_handler,
    build_chat_response_context,
    process_chat_payload,
    process_chat_response,
)
from ruvie.utils.models import (
    check_model_access,
    get_all_base_models,
    get_all_models,
    get_filtered_models,
)
from ruvie.utils.oauth import (
...
from ruvie.utils.plugin import install_tool_and_function_dependencies
from ruvie.utils.redis import get_redis_client
from ruvie.utils.security_headers import SecurityHeadersMiddleware
from ruvie.utils.session_pool import get_session
from ruvie.utils.tools import set_terminal_servers, set_tool_servers
...
async def lifespan(app: FastAPI):
    ...
    from ruvie.utils.automations import scheduler_worker_loop
    ...
    from ruvie.utils.session_pool import close_session
...
if ENABLE_OTEL:
    from ruvie.utils.telemetry.setup import setup as setup_opentelemetry
...
async def initialize_runtime_config(app: FastAPI):
    ...
    from ruvie.utils.access_control import migrate_access_control
...
# `ruvie.utils.asgi_middleware` for the rationale.
...
from ruvie.utils.anthropic import (
